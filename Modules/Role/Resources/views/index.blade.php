		...
		<div class="kt-portlet__head-toolbar">
			<div class="kt-portlet__head-wrapper">
				<div class="kt-portlet__head-actions">
					...
					<a href="{{ route('role.create') }}" class="btn btn-brand btn-elevate btn-icon-sm la la-plus" >
					</a>
				</div>
			</div>
		</div>
...
<script>
		KTUtil.ready(function() {
			...
			var url = "{{ route('role.datatable') }}";
			var targetRender = {
				'0':{'type' : '', 'orderable': false },
				'-1':{'type' : 'actions','orderable': false}
			};
			var filter = {
				'Nama Role':{'name':'nama','type':'text','id':'nama'},
				'Deskripsi Role':{'name':'deskripsi','type':'text','id':'deskripsi'},
			};
			// var order   = [[0, "asc"]];
