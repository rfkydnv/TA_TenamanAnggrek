...
<body>
	<div class="tm-page-wrap mx-auto">
		<div class="position-relative">
                                    ...
                                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                                        <ul class="navbar-nav text-uppercase">
                                            ...
                                            <li class="nav-item active">
                                                <a class="nav-link tm-nav-link" href="{{ route('home.about') }}">About <span class="sr-only">(current)</span></a>
                                            </li>
                                            <li class="nav-item">
			...
			<div class="tm-welcome-container tm-fixed-header2">
            ...
            <div >
                ...
                <div class="parallax-window" data-parallax="scroll" data-image-src="pictures/tn-03.jpg"></div>
            </div> <!-- Header image -->
					...
					<div class="row mt-3 mb-5 pb-3">
						<div class="col-12">
							<div class="mx-auto tm-about-text-container px-3">
								<h2 class="tm-page-title mb-4 tm-text-primary">Tentang Tanaman Anggrek</h2>
								<p class="mb-4">
                                    Bunga anggrek yaitu bunga yang unik, bunga anggrek memiliki berbagai tipe warna, ada bunga anggrek putih, merah muda, kuning, ungu dan terdapat beberapa lagi, bunga itu bisa termasuk juga cukup unik karena memiliki beragam type tipe. Anggrek juga satu di antara dalam group tumbuhan rambat. Bunga Anggrek memiliki nama latin Orchidaceae, bunga inimerupakan satu suku tumbuhan berbunga dengan anggota tipe paling banyak. Tipe-jenisnya menebar luas dari daerah tropika basah hingga tempat sirkumpolar, walau sebagian besar anggotanya di kenali di daerah tropika. Biasanya anggota suku ini hidup sebagai epifit, terutama yang datang dari daerah tropika. Anggrek di daerah beriklim tengah biasanya hidup di tanah dan buat umbi sebagai langkah cocokkan pada musim dingin. Organ-organnya yang cenderung tak tidak tebal dan “berdaging” (sukulen) membuatnya tahan hadapi tekanan ketersediaan air. Anggrek epifit dapat hidup dari embun dan udara lembap. Orchidaceae yakni sumber inspirasi dari nama kereta api Argo Anggrek, kereta api eksekutif yang melayani Surabaya Pasar Turi-Gambir. Bunga Anggrek yang Indah Monopodial Anggrek ini hanya memiliki satu batang dan satu titik tumbuh saja. Bunganya tumbuh dari ujung batang. Anggrek ini dapat diperbanyak dengan stek batang dan biji. contoh : Vanda sp. , dan Phalaenopsis sp.</p>
                                <p class="mb-4">Simpodial</p>
								<p class="mb-4">Simpodial Anggek ini memiliki semakin lebih satu titik tumbuh. Tunas baru terlihat dari sekitar batang paling penting. Bunga bisa terlihat di pucuk atau sisi batang, tetapi ada juga yang terlihat dari akar tinggal. Batangnya menyimpan air cadangan makanan atau umbi semu. Anggrek ini dapat diperbanyak melalui langkah split, pemisahan keiki, biji. Contoh : Dendrobium sp. , Cattleya sp.</p>
                                <p class="mb-4">Anggrek Epifit</p>
								<p class="mb-4">Anggrek Epifit Anggrek yang tumbuh menumpang pada pohon lain tidak ada merugikan tanaman inangnya dan membutuhkan naungan dari cahaya matahari. Akar anggrek menyerap makanan dari air hujan, kabut dan udara sekitar. Contoh : Cattleya sp. , Dendrobium sp. , Vanda sp. Phalaenopsis sp.</p>
							</div>							
						</div>						
					</div>					
				</div>
