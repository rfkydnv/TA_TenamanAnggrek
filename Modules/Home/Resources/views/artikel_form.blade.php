				...
				<main>
					<div class="row mb-5 pb-4">
						<div class="col-12">
							...
							<img src="<?php echo @$data->artikel_foto ?>" alt="Image" style="width: 100%; height: auto; border: none;" class="img-fluid tm-catalog-item-img">
						</div>
					</div>
					<div class="row mb-5 pb-5">
						<div class="col-xl-8 col-lg-7">
							...
							<div class="tm-video-description-box">
								<h2 class="mb-5 tm-video-title"> {{@$data->artikel_judul}}</h2>
								<p class="mb-4">{{@$data->artikel_isi}}.</p>
							</div>							
						</div>
                    ...
                    <div class="col-xl-12 col-lg-12 mb-4">
                        <div class="tm-bg-gray p-5 h-100">
                            <h3 class="tm-text-primary mb-3">Komentar</h3>
							<form action="{{ route('home.store') }}" method="POST" class="tm-subscribe-form">
								@csrf
                                <input type="hidden" name="komentar_artikelid" value="{{$data->artikel_id}}">
                                <input type="text" name="komentar_email" placeholder="Your Email..." required>
                                <input type="text" name="komentar_isi" placeholder="Your Comment...">
                                <button type="submit" class="btn rounded-0 btn-primary tm-btn-small" >Kirim</button>
								{{-- <a href="{{ route("home.edit",$data->artikel_id) }}" class="btn btn-secondary myredirect"></a> --}}
							</form>
							<br>
							<div class="col-xl-12 col-lg-12 mb-12">
								...
								<?php if(count($komentar) == 0){;?>
									<h3 class="tm-text-primary mb-3 tm-catalog-item-title"> Belum ada komentar</h3>
								<?php } ?>

								<div  style="backdground: white">
									<?php foreach($komentar as $key=>$value){;?>
										<h3 class="tm-text-primary mb-3 tm-catalog-item-title"><?php echo $value->komentar_email ?></h3>
										<p class="tm-catalog-item-text"><?php echo @substr($value->komentar_isi , 0, 100)?> . . .</p>
									<?php } ?>
								</div>
							</div>
						</div>
