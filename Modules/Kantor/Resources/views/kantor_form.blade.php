                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-section kt-section--first">
                                        ...
                                        <div class="form-group">
                                            <validation-provider name="name" rules="required">
                                                <div slot-scope="{ errors }">
                                                    ...
                                                    <input type="text" v-model="form.kantor_nama" class="form-control">
                                                    <p>@{{ errors[0] }}</p>
                                                </div>
                                            </validation-provider>
                                        </div>
                                        <div class="form-group">
                                            <validation-provider name="tipe" rules="required">
                                                <div slot-scope="{ errors }">
                                                    ...
                                                    <select class="form-control" id="tipe" v-model="form.kantor_tipe">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <label>Lokasi</label>
                                                <select-2-url v-model="form.kantor_lokasi_id" id="lokasi_id"
                                                              :selected="{{json_encode(@$lokasi)}}"
                                                              url="/select-2/master_kecamatan-kecamatan-id-nama/get"
                                                              name="menu"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <validation-provider name="keterangan" rules="required">
                                                <div slot-scope="{ errors }">
                                                    ...
                                                    <input type="text" v-model="form.kantor_keterangan" class="form-control">
                                                    <p>@{{ errors[0] }}</p>
                                                </div>
                                            </validation-provider>
                                        </div>
