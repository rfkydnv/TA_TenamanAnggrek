							...
							<div class="kt-login__signin">
								...
								<form class="kt-form" action="{{ route('login') }}" method="POST">
									...
									<div class="input-group">
										<input id="email" class="form-control @error('karyawan_username') is-invalid @enderror"  type="text" placeholder="Email or Username" name="karyawan_username" autocomplete="email" autofocus value="{{ old('karyawan_username') }}">
										@error('karyawan_username')
									...
									<div class="kt-login__actions">
										<button id="btn-signin" class="btn btn-brand btn-pill kt-login__btn-primary">Sign In</button>
									</div>
								</form>
							</div>
