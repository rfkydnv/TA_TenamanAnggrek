...
-->
		...
		<!-- begin:: Aside Menu -->
		<div class="kt-aside-menu-wrapper kt-grid__item t-grid__item--fluid" id="kt_aside_menu_wrapper" > {{----}}
			<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" > {{----}}
				<ul class="kt-menu__nav " > {{-- data-turbolinks-permanent --}}
					
					@foreach (session('menu') as $rows)
						@php
								AppCoreHelper::setMenuActive();
                                $isHaveSubMenu = is_array($rows['link']) ? TRUE : FALSE;
                                $link = !is_array($rows['link']) ? $rows['link'] : "javascript:;";
                                $isTurboLinks = $isHaveSubMenu ? 'false' : 'true';
						@endphp
						<li class="kt-menu__item {{ $isHaveSubMenu ? 'kt-menu__item--submenu' : '' }} {{ AppCoreHelper::menuActive($rows['name']) }}" aria-haspopup="true" {{ $isHaveSubMenu ? "data-ktmenu-submenu-toggle=hover" : '' }}>
							<a href="{{url($link)}}" class="kt-menu__link {{$isHaveSubMenu ? 'kt-menu__toggle parent-menu-turbo' : '' }}" data-turbolinks="{{$isTurboLinks}}">
								<i class="{{$rows['icon']}} kt-menu__link-icon"></i>
								<span class="kt-menu__link-text">{{$rows['name']}}</span>
								@if ($isHaveSubMenu)
					...
					<li class="kt-menu__item  kt-menu__item--submenu active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
					...
					<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
						...
						<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
							<ul class="kt-menu__subnav">
								...
								<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open kt-menu__item--here" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Wizard</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu ">
										<span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="demo1/custom/pages/wizard/wizard-1.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Wizard 1</span></a></li>
