	...
	<div class="kt-demo-panel__body">
		<div class="kt-demo-panel__item kt-demo-panel__item--active">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo1.jpg')}}" alt="" />
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo2.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo3.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo4.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo5.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo6.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo7.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo8.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo9.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo10.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo11.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo12.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo13.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
		...
		<div class="kt-demo-panel__item ">
			...
			<div class="kt-demo-panel__item-preview">
				<img src="{{asset('metronic/media/demos/preview/demo14.jpg')}}" alt="" />
				<div class="kt-demo-panel__item-preview-overlay">
					<a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
				</div>
			</div>
